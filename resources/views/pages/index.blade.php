                                    ...
                                    Server Status</h4>
                                        ...
                                        <div role="progressbar" aria-valuenow="55" aria-valuemin="0"
                                            ...
                                            <span class="sr-only">55% Complete (success)</span></div>
                                                ...
                                                </span><span>Domain (2/5)<small class="pull-right text-muted">66%
                ...
                <div class="portlet box">
                    ...
                    <div class="portlet-body">
                        <div class="chat-scroller">
                            <ul class="chats">
                                <li class="in">
                                    <img src="{!!asset ('assets/images/avatar/48.jpg') !!}"
                        ...
                        <div class="profile">
                            <div style="margin-bottom: 15px" class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 text-center">
                                    <figure><img src="{!!asset ('assets/images/avatar/128.jpg" alt=""
